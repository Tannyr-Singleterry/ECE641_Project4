...
#    * The helper routines are defined in sdram_pll_altera_iopll_2100_cv5i6vy_pin_map.tcl
#
# NOTE
# ----
...
source "$script_dir/sdram_pll_altera_iopll_2100_cv5i6vy_parameters.tcl"
source "$script_dir/sdram_pll_altera_iopll_2100_cv5i6vy_pin_map.tcl"
source "$script_dir/sdram_pll_altera_iopll_2100_cv5i6vy_all_ip_params.tcl"
...
if {[info exists ::GLOBAL_top_sdram_pll_altera_iopll_2100_cv5i6vy_corename_ai_pll_db]} {
    # Clean-up stale content
    unset ::GLOBAL_top_sdram_pll_altera_iopll_2100_cv5i6vy_corename_ai_pll_db
}
if {[catch {ai_initialize_pll_db ::GLOBAL_top_sdram_pll_altera_iopll_2100_cv5i6vy_corename_ai_pll_db} err_initializing_db]} {
...
# following loop
set instances [ array names ::GLOBAL_top_sdram_pll_altera_iopll_2100_cv5i6vy_corename_ai_pll_db ]
foreach { inst } $instances {
    ...
    lassign $::GLOBAL_top_sdram_pll_altera_iopll_2100_cv5i6vy_corename_ai_pll_db($inst) base_clock_data_dict gen_clock_data_dict
