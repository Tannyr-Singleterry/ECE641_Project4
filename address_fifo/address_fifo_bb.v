module address_fifo (
		input  wire [23:0] data,  //  fifo_input.datain,  Data input of the memory.The data port is required for all FIFO operation.
		...
		output wire [23:0] q,     // fifo_output.dataout, Data output of the memory. This port is required for all FIFO operation.
		output wire [2:0]  usedw, //            .usedw,   Show the number of words stored in the FIFO.
