...
module address_fifo (
	...
	address_fifo_fifo_1941_4rtf7ny fifo_0 (
		.data  (data),  //   input,  width = 24,  fifo_input.datain
		...
		.q     (q),     //  output,  width = 24, fifo_output.dataout
		.usedw (usedw), //  output,   width = 3,            .usedw
