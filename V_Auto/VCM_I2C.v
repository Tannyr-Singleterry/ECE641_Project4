...
CLOCKMEM c1( .RESET_n(RESET_N), .CLK ( CLK_50 ) , .CLK_FREQ ( 125 )  , .CK_1HZ (CLK_400K) ) ; 
...
assign I2C_SDAO            = W_POINTER_SDAO & R_SDAO  & W_WORD_SDAO;   // DG from SDAO
